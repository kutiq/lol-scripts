...
-- / Hero Name Check / --
_G.Kata_Autoupdate = false

-- / Auto-Update Function / --
local script_downloadName = "Katarina - ku"
local script_downloadHost = "raw.github.com"
local script_downloadPath = "/kutiq/lol-scripts/Katarina%20-%20ku.lua" .. "?rand=" .. math.random(1, 10000)
...
function KatarinaMenu()
	--- Main Menu ---
	--->
		KatarinaMenu = scriptConfig("Katarina - ku", "Katarina")
		---> Combo Menu
		...
		---<
		---> Arrange Priorities
			if heroManager.iCount < 10 then -- from sac
